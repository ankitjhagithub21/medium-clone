        ...
        <div className='h-[100vh] w-full bg-[#F7F4ED] lg:overflow-hidden'>
            <div className='border-b border-black'>
                <div className='container px-5 mx-auto flex items-center h-[10vh] justify-between'>
                    <Link to={"/"}>
                        <svg viewBox="0 0 3940 610" className='w-40'>
            ...
            <div className='h-[80vh] p-5 container mx-auto flex items-center'>
            ...
            <div className='border-t  border-black h-[10vh] flex items-center justify-center gap-5 text-gray-600 text-sm'>
                ...
                <span className='hidden lg:block'>Press</span>
                <span className='hidden lg:block'>Blog</span>
                <span>Privacy</span>
                <span>Terms</span>
                <span className='hidden lg:block'>Text to speech</span>
